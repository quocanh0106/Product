...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'product/category/edit';
    const CMS_URL_PATH_DELETE = 'product/category/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['id'])) {
                    ...
                    $name_cate = $this->getEscaper()->escapeHtml($item['name_cate']);
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CMS_URL_PATH_DELETE, ['id' => $item['id']]),
                        'label' => __('Delete'),
                        'confirm' => [
                            'name_cate' => __('Delete %1', $name),
